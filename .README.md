...
Set behaviour:
    New Tab -> Sibling of current tab
New shortcut in Manage Extension Shortcuts:
    New Independent Tab: Ctrl + Y
...
- `pacman -Syu i3 feh rofi fish nvim ttf-hack-nerd starship git-delta rg`
- Install https://github.com/academo/ww-run-raise 
...
- Key repeat: Delay: 300ms, Rate: 25/s
